...
@Component({
  selector: 'app-create-connection-parameter',
  templateUrl: './create-connection-parameter.component.html',
  styleUrls: ['./create-connection-parameter.component.css'],
  animations: [
...
export class CreateConnectionParameterComponent implements OnInit {
  // Data emit to parent
  @Output() navigateToCreateIntegration = new EventEmitter<void>();
  ...
  // Data source
  gridDataSource: apps[] = [];
  dataSource: apps | null = Object() || null;
  ...
  constructor( private IS: IntegrationService, private dialog: MatDialog, public dialogRef: MatDialogRef<DialogContentComponent> ) {
  ...
  Previous(): void {
    ...
    this.navigateToCreateIntegration.emit();
  }
